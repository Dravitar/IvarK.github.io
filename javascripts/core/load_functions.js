...
function transformSaveToDecimal() {
  ...
  player.ninthCost = new Decimal(player.ninthCost)
  ...
  player.ninthAmount = new Decimal(player.ninthAmount)
  ...
  player.ninthPow - new Decimal(player.ninthPow)
  ...
  player.infinityDimension9.amount = new Decimal(player.infinityDimension9.amount)
  ...
  player.timeDimension9.amount = new Decimal(player.timeDimension9.amount)
  ...
  player.timeDimension9.cost = new Decmial(player.timeDimension9.cost)
  ...
  player.timeDimension9.power = new Decimal(player.timeDimension9.power)
  ...
  player.heresyDimension1.amount = new Decimal(player.heresyDimension1.amount)
  player.heresyDimension2.amount = new Decimal(player.heresyDimension2.amount)
	player.heresyDimension3.amount = new Decimal(player.herestDimension3.amount)
	player.heresyDimension4.amount = new Decimal(player.heresyDimension4.amount)
	player.heresyDimension5.amount = new Decimal(player.heresyDimension5.amount)
	player.heresyDimension6.amount = new Decimal(player.heresyDimension6.amount)
	player.heresyDimension7.amount = new Decimal(player.heresyDimension7.amount)
	player.heresyDimension8.amount = new Decimal(player.heresyDimension8.amount)
	player.heresyDimension9.amount = new Decimal(player.heresyDimension9.amount)
	player.heresyDimension1.cost = new Decimal(player.heresyDimension1.cost)
  player.heresyDimension2.cost = new Decimal(player.heresyDimension2.cost)
	player.heresyDimension3.cost = new Decimal(player.herestDimension3.cost)
	player.heresyDimension4.cost = new Decimal(player.heresyDimension4.cost)
	player.heresyDimension5.cost = new Decimal(player.heresyDimension5.cost)
	player.heresyDimension6.cost = new Decimal(player.heresyDimension6.cost)
	player.heresyDimension7.cost = new Decimal(player.heresyDimension7.cost)
	player.heresyDimension8.cost = new Decimal(player.heresyDimension8.cost)
	player.heresyDimension9.cost = new Decimal(player.heresyDimension9.cost)
	player.heresyDimension1.power = new Decimal(player.heresyDimension1.power)
  player.heresyDimension2.power = new Decimal(player.heresyDimension2.power)
	player.heresyDimension3.power = new Decimal(player.herestDimension3.power)
	player.heresyDimension4.power = new Decimal(player.heresyDimension4.power)
	player.heresyDimension5.power = new Decimal(player.heresyDimension5.power)
	player.heresyDimension6.power = new Decimal(player.heresyDimension6.power)
	player.heresyDimension7.power = new Decimal(player.heresyDimension7.power)
	player.heresyDimension8.power = new Decimal(player.heresyDimension8.power)
	player.heresyDimension9.power = new Decimal(player.heresyDimension9.power)
	player.heresyPoints = new Decimal(player.heresyPoints)
	player.hpmultCost = new Decimal(player.hpmultCost)
}
